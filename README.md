это лишь простой пример который показывает как работает block chain, но это не всё обычно ещё нужно сделать подключение к клиенту и обработка данных из бд
